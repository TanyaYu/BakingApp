...
import com.example.tanyayuferova.bakingapp.databinding.ActivityStepsBinding;
...
public class StepsActivity extends AppCompatActivity
    ...
    public static class PlaceholderFragment extends Fragment {
         ...
         * number.
         */
        public static PlaceholderFragment newInstance(Step item) {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter  {
        ...
        public Fragment getItem(int position) {
            return PlaceholderFragment.newInstance(steps.get(position));
        }
    ...
    public void onPageSelected(int position) {
        ...
        getSupportActionBar().setTitle(step.getStepTitle(this));
        ...
        // Show video dialog if orientation is landscape
